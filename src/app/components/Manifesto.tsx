export default function Manifesto() {
  return (
    <section className="py-32 px-6 relative">
      {/* Copper accent line */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-24 bg-gradient-to-b from-copper/50 to-transparent" />
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-24">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-normal leading-tight mb-8 text-marble">
            The signal is drowning in noise.
          </h2>
          <div className="glass p-8 rounded-sm border-t border-copper/30">
        ...
        <div className="relative">
          ...
          <div className="glass p-8 rounded-sm border border-copper/20">
            ...
            <div className="flex flex-wrap gap-3 font-mono text-xs">
              {["Daily Intel", "Private Discord", "Weekly Calls", "Resource Library"].map((tag) => (
                <span key={tag} className="px-4 py-2 border border-stone rounded-sm text-foreground-muted">
                  {tag}
                </span>
              ))}
            </div>
